// SaaSWriter — Tailwind Design Tokens
// Paste the `theme.extend` block into tailwind.config.mjs
...
export const tokens = {
  ...
  fontSize: {
    ...
    'micro': ['9px', { lineHeight: '1.4', letterSpacing: '0.12em' }],
  },
  ...
  boxShadow: {
    'green-glow': '0 0 0 1px rgba(74, 222, 128, 0.2), 0 40px 80px rgba(0,0,0,0.6)',
